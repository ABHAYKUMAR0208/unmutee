  ...
  return (
    <html lang="en" className={satoshi.className}>
      <head>
        ...
        />
        {/* Voice-AI-Agent-UI fonts */}
        <link
          href="https://fonts.googleapis.com/css2?family=Rajdhani:wght@400;500;600;700&family=Barlow:wght@300;400;500;600;700;800&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
