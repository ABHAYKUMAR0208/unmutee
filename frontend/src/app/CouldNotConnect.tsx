...
const CouldNotConnect = ({ healthStatus }: { healthStatus: HealthStatus }) => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col gap-12 items-center justify-center bg-background text-white pt-24">
      <UnmuteHeader />
      <div className="text-center text-xl">
        <h1 className="text-3xl mb-4" style={{ fontFamily: "'Rajdhani', sans-serif" }}>
          {"Couldn't connect :("}
        </h1>
        <p className="text-textgray">Service status:</p>
        {renderServiceStatus(
          "Backend",
